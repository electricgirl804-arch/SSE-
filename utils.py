...
# الشعار SSE - base64 كامل عشان يشتغل في التطبيق
LOGO = """
...حطي الكود الكامل بتاعك هنا...END"""
...
def show_header():
    ...
    <div class="header">
        ...
        <div>
            <h1>SSE - Smart Solara Engineer</h1>
            <h3>شركة شهد للطاقة الشمسية الذكية</h3>
        </div>
    </div>
    """, unsafe_allow_html=True)
